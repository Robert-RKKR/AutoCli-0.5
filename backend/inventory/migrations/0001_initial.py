    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credentials', models.ManyToManyField(blank=True, help_text='All credentials that belongs to current color.', to='inventory.Credential', verbose_name='Credentials')),
                ('devices', models.ManyToManyField(blank=True, help_text='All devices that belongs to current color.', to='inventory.Device', verbose_name='Devices')),
                ('folders', models.ManyToManyField(blank=True, help_text='All folder that belongs to current color.', to='inventory.Folder', verbose_name='Folders')),
            ],
            options={
                'verbose_name': 'Color',
